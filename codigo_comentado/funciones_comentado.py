from validaciones_comentado import *
from heroes_comentado import lista_heroes
...
def mostrar_lista_heroes(lista: list):
    """
    Muestra todos los héroes de la lista con sus datos completos.

    Parámetros:
        lista (list): Lista bidimensional de héroes.
    """
...
def agregar_heroe(lista: list):
    """
    Solicita los datos de un nuevo héroe al usuario y lo agrega a la lista.

    Parámetros:
        lista (list): Lista bidimensional de héroes donde se agregará el nuevo.
    """
...
def eliminar_de_lista(
    ...
    """
    Elimina un héroe de la lista según el nombre ingresado por el usuario.

    Parámetros:
        lista (list): Lista bidimensional de héroes.
        mensaje_no_encontrado (str): Mensaje a mostrar si no se encuentra.
        mensaje_encontrado (str): Mensaje a mostrar si se elimina con éxito.
    """
    encontrado = False
    nombre = validar_cadena(
...
def ordenar_alfabeticamente_heroes(lista: list) -> list:
    """
    Ordena la lista de héroes alfabéticamente por nombre de la A a la Z
    y muestra el resultado.

    Parámetros:
        lista (list): Lista bidimensional de héroes a ordenar.
    """
...
def buscar_mayor_heroe(lista: list, indice: int):
    """
    Busca y muestra el héroe con el valor más alto en el índice indicado.

    Parámetros:
        lista (list): Lista bidimensional de héroes.
        indice (int): Índice del atributo a comparar.
    """
    mayor = lista[0]
    for i in range(len(lista)):
...
def buscar_menor_heroe(lista: list, indice: int):
    """
    Busca y muestra el héroe con el valor más bajo en el índice indicado.
